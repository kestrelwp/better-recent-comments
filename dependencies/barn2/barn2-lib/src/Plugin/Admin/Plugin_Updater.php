...
namespace Barn2\Plugin\Better_Recent_Comments\Dependencies\Lib\Plugin\Admin;

use Barn2\Plugin\Better_Recent_Comments\Dependencies\Lib\Plugin\License\License_API;
...
class Plugin_Updater implements Registerable
{
    ...
    {
        if (\is_admin() || \defined('Barn2\\Plugin\\Better_Recent_Comments\\Dependencies\\WP_CLI') && WP_CLI) {
